Contributing to Schilling Coin
============================

The Schilling Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/schillingcoin-project/schillingcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Schilling Coin project, and is not to be
confused with overall SchillingCoin Network Protocol consensus changes.

Whether a pull request is merged into Schilling Coin rests with the project merge
...
Patches that change SchillingCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the SchillingCoin consensus, it must have been
...
The project leader is the release manager for each Schilling Coin release.
