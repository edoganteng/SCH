...
class RawTransactionsTest(SchillingcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid schillingcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid schillingcoin address" in e.error['message'])
