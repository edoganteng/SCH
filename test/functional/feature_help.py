...
"""Verify that starting schillingcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import SchillingcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(SchillingcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start schillingcoin with -h for help text")
        ...
        self.log.info("Start schillingcoin with -version for version information")
