...
The script [extract-osx-sdk.sh](https://github.com/schillingcoin-project/schillingcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
schillingcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/schillingcoin-project/schillingcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
