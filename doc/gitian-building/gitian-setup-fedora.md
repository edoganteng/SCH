...
The build script we'll be using is contained in the SchillingCoin github repository ([contrib/gitian-build.py](https://github.com/schillingcoin-project/schillingcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the SchillingCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/SchillingCoin-Project/SchillingCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, schillingcoin-detached-sigs, and schillingcoin GitHub repos.
