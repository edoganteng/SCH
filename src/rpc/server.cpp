...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"schillingcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"schillingcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"schillingcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"schillingcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"schillingcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"schillingcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"schillingcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"schillingcoin", "startmasternode", &startmasternode, true, true, false},
        {"schillingcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"schillingcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"schillingcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
...
{
    return "> schillingcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9071/\n";
}
