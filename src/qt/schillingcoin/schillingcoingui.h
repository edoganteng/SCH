...
#ifndef SchillingCoin_CORE_NEW_GUI_SchillingCoinGUI_H
#define SchillingCoin_CORE_NEW_GUI_SchillingCoinGUI_H
...
#include "qt/schillingcoin/receivewidget.h"
#include "qt/schillingcoin/addresseswidget.h"
#include "qt/schillingcoin/coldstakingwidget.h"
#include "qt/schillingcoin/masternodeswidget.h"
#include "qt/schillingcoin/snackbar.h"
#include "qt/schillingcoin/settings/settingswidget.h"
...
/**
  SchillingCoin GUI main class. This class represents the main window of the SchillingCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SchillingCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SchillingCoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SchillingCoinGUI();
...
#endif //SchillingCoin_CORE_NEW_GUI_SchillingCoinGUI_H
