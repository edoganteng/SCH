...
#include "qt/schillingcoin/forms/ui_receivewidget.h"
...
#include "qt/schillingcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(SchillingCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive SCH."));
