...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, SchillingCoinGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, SchillingCoinGUI *gui, double posX = 3);
