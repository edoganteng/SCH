...
#ifndef SchillingCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SchillingCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SchillingCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
