...
#include "qt/schillingcoin/forms/ui_sendchangeaddressdialog.h"
    ...
    ui(new Ui::SendChangeAddressDialog)
{
    ...
    ui->labelMessage->setText(tr("The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" SchillingCoin address"));
    ui->labelMessage->setProperty("cssClass", "text-main-grey");

    ui->lineEditAddress->setPlaceholderText("Enter SchillingCoin address (e.g ZmkEBAFKzay6fMaYp3ZB… ");
