...
#include "qt/schillingcoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(SchillingCoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    // App version
    ui->labelVersion->setText(QString(tr("v%1")).arg(QString::fromStdString(FormatFullVersionWithCodename())));
