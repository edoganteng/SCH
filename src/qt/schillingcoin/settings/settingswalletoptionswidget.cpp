...
#include "qt/schillingcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/schillingcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SchillingCoinGUI* _window, QWidget *parent) :
