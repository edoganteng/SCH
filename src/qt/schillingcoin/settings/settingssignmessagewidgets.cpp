...
#include "qt/schillingcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(SchillingCoinGUI* _window, QWidget *parent) :
