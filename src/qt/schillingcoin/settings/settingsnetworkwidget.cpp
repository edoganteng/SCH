...
#include "qt/schillingcoin/settings/settingsnetworkwidget.h"
#include "qt/schillingcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/schillingcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SchillingCoinGUI* _window, QWidget *parent) :
