...
#include "qt/schillingcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    ui->labelContent7->setOpenExternalLinks(true);
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://schillingcoin.org/");
