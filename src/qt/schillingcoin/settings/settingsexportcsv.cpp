...
#include "qt/schillingcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SchillingCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SchillingCoin_tx_csv_export(*.csv)") : tr("SchillingCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
