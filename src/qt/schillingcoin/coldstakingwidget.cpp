...
#include "qt/schillingcoin/coldstakingwidget.h"
#include "qt/schillingcoin/forms/ui_coldstakingwidget.h"
#include "qt/schillingcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/schillingcoin/requestdialog.h"
#include "qt/schillingcoin/tooltipmenu.h"
#include "qt/schillingcoin/furlistrow.h"
#include "qt/schillingcoin/sendconfirmdialog.h"
#include "qt/schillingcoin/addnewcontactdialog.h"
#include "qt/schillingcoin/guitransactionsutils.h"
#include "walletmodel.h"
#include "optionsmodel.h"
#include "coincontroldialog.h"
#include "coincontrol.h"
#include "qt/schillingcoin/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(SchillingCoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your SCH, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept SCH delegation / Delegate SCH"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select SCH outputs to delegate.");
...
void ColdStakingWidget::onCoinControlClicked(){
    if(isInDelegation) {
        if (walletModel->getBalance() > 0) {
            ...
            inform(tr("You don't have any SCH to select."));
        }
    }
}
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 SCH" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
