...
#include <QWidget>
#include <QString>
#include "qt/schillingcoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(SchillingCoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    SchillingCoinGUI* getWindow() { return this->window; }
...
protected:
    SchillingCoinGUI* window = nullptr;
