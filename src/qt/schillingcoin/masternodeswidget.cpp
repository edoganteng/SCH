...
#include "qt/schillingcoin/forms/ui_masternodeswidget.h"
#include "qt/schillingcoin/qtutils.h"
#include "qt/schillingcoin/mnrow.h"
#include "qt/schillingcoin/mninfodialog.h"

#include "qt/schillingcoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(SchillingCoinGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked(){
    ...
    if (walletModel->getBalance() <= (COIN * GetMNCollateral())) {
        inform(tr("Not enough balance to create a masternode, %1 SCH required.").arg(GetMNCollateral()));
        return;
    }
    showHideOp(true);
