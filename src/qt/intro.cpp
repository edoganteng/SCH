...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Schilling Coin"),
     ...
     * override -datadir in the schillingcoin.conf file in the default data directory
     * (to be consistent with schillingcoind behavior)
     */
