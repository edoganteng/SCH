...
/* SchillingCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SchillingCoin"
#define QAPP_ORG_DOMAIN "schillingcoin.org"
#define QAPP_APP_NAME_DEFAULT "SchillingCoin-Qt"
#define QAPP_APP_NAME_TESTNET "SchillingCoin-Qt-testnet"
