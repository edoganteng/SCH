...
#include "qt/schillingcoin/loadingdialog.h"
                                                                                                            ...
                                                                                                            btnWatch(new QCheckBox())
{
	...
	ui->passWarningLabel->setProperty("cssClass", "pass-warning");
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                " <b>" + tr("LOSE ALL OF YOUR SCH") + "</b>!<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            newpassCache = newpass1;
            SchillingCoinGUI* window = static_cast<SchillingCoinGUI*>(parentWidget());
...
{
    SchillingCoinGUI* gui = static_cast<SchillingCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<SchillingCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("SchillingCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SCH from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
