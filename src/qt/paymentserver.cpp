...
const char* BIP71_MIMETYPE_PAYMENT = "application/schillingcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/schillingcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/schillingcoin-paymentrequest";
...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++) {
        ...
        // If the schillingcoin: URI contains a payment request, we are not able to detect the
                                                                       ...
                                                                       optionsModel(0)
{
    ...
    // on Mac: sent when you click schillingcoin: links
...
//
// OSX-specific way of handling schillingcoin: URIs and
// PaymentRequest mime types
//
bool PaymentServer::eventFilter(QObject* object, QEvent* event)
{
    // clicking on schillingcoin: URIs creates FileOpen events on the Mac
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in schillingcoin: URIs
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // schillingcoin: URI
    {
