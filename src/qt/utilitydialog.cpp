...
#include "qt/schillingcoin/qtutils.cpp"
                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Schilling Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersionWithCodename());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About Schilling Coin"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #89FEAF;text-decoration:none'  href=\"\\1\">\\1</a>");
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
            tr("Schilling Coin is shutting down...") + "<br /><br />" +
