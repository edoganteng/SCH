...
#ifndef SchillingCoin_QT_WALLETMODEL_H
#define SchillingCoin_QT_WALLETMODEL_H
...
/** Interface to SchillingCoin wallet from Qt view code. */
...
#endif // SchillingCoin_QT_WALLETMODEL_H
