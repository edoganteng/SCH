...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Schilling Coin schillingcoin-tx utility version") + " " + FormatFullVersionWithCodename() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  schillingcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded schillingcoin transaction") + "\n" +
                               "  schillingcoin-tx [options] -create [commands]   " + _("Create hex-encoded schillingcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded schillingcoin transaction
